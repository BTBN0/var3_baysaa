...
import { Phone, MessageCircle, UserPlus, AtSign, Bell, X } from "lucide-react";
import { imgUrl } from "../../utils/url.js";

const META = {
  dm:              { grad: "linear-gradient(135deg,#1B3066,#2a4080)", accent: "#2a4080", Icon: MessageCircle },
  channel_message: { grad: "linear-gradient(135deg,#0f4c8a,#1B3066)", accent: "#3b82f6", Icon: MessageCircle },
  mention:         { grad: "linear-gradient(135deg,#d97706,#b45309)", accent: "#f59e0b", Icon: AtSign        },
  reaction:        { grad: "linear-gradient(135deg,#7c3aed,#5b21b6)", accent: "#8b5cf6", Icon: Bell          },
  ...
  missed_call:     { grad: "linear-gradient(135deg,#ef4444,#dc2626)", accent: "#ef4444", Icon: Phone         },
