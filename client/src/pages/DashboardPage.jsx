      ...
      <div style={{ flex: 1, maxWidth: 720, width: "100%", margin: "0 auto", padding: "48px 24px" }}>
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 28 }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <button
              ...
              style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", background: "var(--text)", border: "none", borderRadius: 9, color: "var(--bg)", fontSize: 13, fontWeight: 600, cursor: "pointer", transition: "opacity 0.15s" }}
        ...
        {loading ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {workspaces.map((ws) => (
              <WorkspaceCard key={ws.id} workspace={ws} onEnter={handleEnter} />
            ))}
          </div>
        )}
      </div>
